...
% function that creates the standard stimuli for the colorful task.First we
% separate between types U and I and then shuffle the trials. From the
% shuffled trials we sample equal amount per set size and then save the
% structure so that defstruct can load it. 
...
%removing update short from trial
